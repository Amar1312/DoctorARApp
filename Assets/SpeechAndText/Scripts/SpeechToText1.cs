...
{
    public class SpeechToText1 : MonoBehaviour
    {

        #region Init
        private static SpeechToText1 _instance;
        public static SpeechToText1 Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    _instance = go.AddComponent<SpeechToText1>();
                }
                return _instance;
            }
        }
        ...
        public void onError(string _value)
        {
            ...
            try
            {
                ...
                Debug.LogError($"Speech Recognition Error ({_error}): {_message}");
            ...
            {
                Debug.LogError($"Error parsing speech error code: {e.Message}");
                if (onErrorCallback != null)
                    onErrorCallback("Speech recognition failed");
            }
        }
